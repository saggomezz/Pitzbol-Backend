...
const DESCRIPCIONES = {
  ...
  "La Chata Terranova, Guadalajara": "Sucursal de la institución gastronómica desde 1942. Los mismos sabores clásicos de pozole rojo y birria en la zona Providencia.",
  ...
  "Los Laureles (Av. México), Guadalajara": "Cocina mexicana casera y reconfortante sobre la avenida México. Caldos y guisados con técnica tradicional en porciones generosas.",
  "Restaurante Casa Luna, Guadalajara": "Ambiente romántico y colonial en el corazón de Tlaquepaque con cocina mexicana artesanal. Música en vivo y postres de autor.",
  ...
  "Pozole El Pollo, Guadalajara": "Pozole rojo de pollo con receta casera en el barrio Santa Teresita. Tortillas hechas a mano y todas las guarniciones tradicionales.",
  ...
  "La Boca Parrilla Rustica, Guadalajara": "Parrilla rústica con cortes de carne premium en la Colonia Americana. Ambiente animado con carnes al carbón; ideal para carnívoros exigentes.",
  ...
  "Argento Americana, Guadalajara": "Cocina argentina con toque mexicano en el barrio Americana. Empanadas crujientes y carnes a la parrilla en un ambiente tranquilo.",
  ...
  "Romea, Guadalajara": "Restaurante mediterráneo con ambiente sofisticado en Vallarta. Mariscos frescos y sabores del sur de Europa con coctelería de diseño.",
  ...
  "Angelina Bistro, Guadalajara": "Bistró de cocina europea con toque mexicano en el poniente de Guadalajara. Brunch los fines de semana y cenas románticas entre semana.",
  // ── Cantinas / Nocturnos ─────────────────────────────────────────────────────
  ...
  "Churros \"La Bombilla\", Guadalajara": "Churros artesanales crujientes con chocolate caliente en el corazón de Guadalajara. Una tradición dulce para rematar un día de turismo.",
  ...
  "Osteria 10, Guadalajara": "Repostería italiana y platillos ligeros en la Colonia Americana. Ambiente acogedor con dulces artesanales; perfecto para una pausa gourmet.",
  // ── Cafeterías ───────────────────────────────────────────────────────────────
  ...
  "Aloó Café, Guadalajara": "Café de especialidad en la Colonia Ladrón de Guevara. Ambiente minimalista con bebidas de autor y repostería fresca.",
  ...
  "Gufo Café, Guadalajara": "Café de especialidad en Chapultepec. Granos de origen y métodos alternativos en un ambiente tranquilo.",
  "Fika, Guadalajara": "Cafetería inspirada en la tradición escandinava del fika. Café artesanal con repostería nórdica en el sur de Guadalajara.",
  ...
  "The Spot Café, Guadalajara": "Cafetería moderna en Providencia. Bebidas de autor y repostería en un espacio tranquilo ideal para trabajar o reunirse.",
  ...
  // ── Vida nocturna con comida ─────────────────────────────────────────────────
  "Gallo Cervecero Sportsbar , Guadalajara": "Bar deportivo con amplia selección de cervezas artesanales y platillos para botanear. El mejor lugar para ver los partidos del Mundial 2026 en ambiente animado.",
  "El Gallo Altanero, Guadalajara": "Bar de ambiente íntimo en la Colonia Americana. Especialidades en mezcales y cócteles creativos en un espacio acogedor para noches tranquilas.",
